...
SlideLayout = 'SSS_MGP2_AbC1_MAP2_647_FOXA2_568_IBA1_488.txt';

SavePath = 'S:\HCS_Platform\Data\SoniaSabate\Operetta\Paper Microglia\FINAL ANALYSIS\ABC1P2';
mkdir(SavePath)
PreviewSavePath = 'S:\HCS_Platform\Data\SoniaSabate\Operetta\Paper Microglia\FINAL ANALYSIS\ABC1P2';
...
InfoTable = readtable ('S:\Operetta\OperettaDB_LCSB\SSS_20191203_MGP2_AbC1_MAP2_647_FOXA2_568_IBA1_488\a95588a3-e741-4b48-b0f8-3827e9689d1b\metadata.csv');   
...
%  for a group of sections, use colon (:) --> example g=[1:15]
    ...
    for g =[1:13] % Number of organoids
    ...
    XYMosaicCells = {};
        ...
        Label = Layout(g,:);
         try
            ObjectsThisOrganoid = New_f_ImageAnalysis_IBA1FOXA2MAP2(Label, CroppedMosaic{1}, CroppedMosaic{2}, CroppedMosaic{3}, CroppedMosaic{4},ChannelNames, PreviewSavePath);
...
%   Objects = Objects(Objects.NucMaskSum > 5000, :);
   ...
   Objects = Objects(Objects.MAP2MaskSumSum > 150000, :);
