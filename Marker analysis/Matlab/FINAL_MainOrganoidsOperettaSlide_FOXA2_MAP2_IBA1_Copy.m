...
SlideLayout = 'SSS_20200120_MGP1_AbC1_MAP2_647_FOXA2_568_IBA1_488.txt';

SavePath = 'S:\HCS_Platform\Data\SoniaSabate\Operetta\Paper Microglia\FINAL ANALYSIS\ABC1P1';
mkdir(SavePath)
PreviewSavePath = 'S:\HCS_Platform\Data\SoniaSabate\Operetta\Paper Microglia\FINAL ANALYSIS\ABC1P1';
...
InfoTable = readtable ('S:\Operetta\OperettaDB_LCSB\SSS_20191203_MGP1_AbC1_MAP2_647_FOXA2_568_IBA1_488\f62f7603-e332-416f-910c-9d25bd9d50ea\metadata.csv');   
...
%  for a group of sections, use colon (:) --> example g=[1:15]
    ...
    for g =[1:15] % Number of organoids
    ...
    XYMosaicCells = {};
        ...
        Label = Layout(g,:);
         try
            ObjectsThisOrganoid = New_f_ImageAnalysis_IBA1FOXA2MAP2_Copy(Label, CroppedMosaic{1}, CroppedMosaic{2}, CroppedMosaic{3}, CroppedMosaic{4},ChannelNames, PreviewSavePath);
